...
def main():
    ...
    LANG_MODEL = "./lm.binary"
    TRIE = "./trie"
    VAD_AGGRESSIVENESS = 3
    DEVICE = 10

    print("Initializing model...")
    logging.info("Model: %s", "./output_graph.pbmm")
    logging.info("Language model: %s", "./lm.binary")
